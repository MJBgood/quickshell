...
Rectangle {
    ...
    Row {
        ...
        // Notification bell icon using MaterialIcon (caelestia pattern)
        MaterialIcon {
            id: bellIcon
            visible: showIcon
            anchors.verticalCenter: parent.verticalCenter
            text: hasUnread ? "notifications" : "notifications_none"
            color: getIconColor()
            font.pointSize: configService ? configService.typography("sm", entityId) : 12
