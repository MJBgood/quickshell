...
Rectangle {
    ...
    property string componentId: "gpu_temp"
    property string parentComponentId: ""
    property var childComponentIds: []
    property string menuPath: "gpu_temp"
    ...
    GpuTempContextMenu {
        ...
        themeService: gpuTempWidget.themeService
        visible: false
    }
    ...
    Component.onCompleted: console.log("[GpuTempWidget] Initialized with TemperatureService")
}